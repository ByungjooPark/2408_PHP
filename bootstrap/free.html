...
<body>
    ...
    <main>
        <div class="card">
            <img src="./img/nondam_ho.webp" class="card-img-top object-fit-cover" style="height: 300px;" alt="...">
            <div class="card-body">
        ...
        <div class="card">
            <img src="./img/nondam_f.png" class="card-img-top object-fit-cover" style="height: 300px;" alt="...">
            <div class="card-body">
                <h5 class="card-title">Card title</h5>
                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                <!-- Button trigger modal -->
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>살려주세요.</p>
                    <br>
                    <img src="./img/nondam_ho.webp" class="card-img-top" alt="">
                </div>
